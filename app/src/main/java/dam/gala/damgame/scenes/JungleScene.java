 ...
 * @version 1.0
 */
public class JungleScene extends Scene {
    private GameActivity gameActivity;

    public JungleScene(GameActivity gameActivity){
        super(gameActivity);
    ...
    public Bitmap getQuestionViewBitmap(int complexity) {
        if(complexity== GameUtil.PREGUNTA_COMPLEJIDAD_ALTA)
            return BitmapFactory.decodeResource(gameActivity.getResources(), R.drawable.jungle_quest_d);
        else
            return BitmapFactory.decodeResource(gameActivity.getResources(), R.drawable.jungle_quest_e);
    }
    ...
    public Bitmap getBouncyViewBitmap() {
        return BitmapFactory.decodeResource(gameActivity.getResources(), R.drawable.jungle_bird);
    }
    ...
    public Bitmap getCrashViewBitmapTop() {
        return BitmapFactory.decodeResource(gameActivity.getResources(), R.drawable.jungle_column_top);
    }

    @Override
    public Bitmap getCrashViewBitmapDown() {
        return BitmapFactory.decodeResource(gameActivity.getResources(), R.drawable.jungle_column_down);
    }
    ...
    public Bitmap getScoreLifes() {
        return BitmapFactory.decodeResource(gameActivity.getResources(), R.drawable.jungle_lifes_score);
    }

    @Override
    public Bitmap getScorePoints() {
        return BitmapFactory.decodeResource(gameActivity.getResources(), R.drawable.jungle_points_score);
    }

    @Override
    public Bitmap getScoreAnswers() {
        return BitmapFactory.decodeResource(gameActivity.getResources(), R.drawable.jungle_answer_score);
    }
}
